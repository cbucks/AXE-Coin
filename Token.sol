...
contract BasicToken is ERC20Basic, Pausable, Whitelist {
  ...
  */
  function transfer(address _to, uint256 _value) public whenNotPaused onlyWhitelisted(msg.sender, recipient) returns (bool) {
...
contract StandardToken is ERC20, BasicToken {
   ...
   */
  function transferFrom(address _from, address _to, uint256 _value) public whenNotPaused onlyWhitelisted(msg.sender, recipient) returns (bool) {
    require(_to != address(0));
